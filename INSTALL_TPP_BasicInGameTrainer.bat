...
SET tpp_install_mod_name=BasicInGameTrainer
SET tpp_install_data=00
SET tpp_install_file=%tpp_install_mod_name%.lua
SET "tpp_install_file_inf=18e2e400a16bf978^|%tpp_install_data%\Assets\tpp\script\lib\%tpp_install_file% key^=0 version^=2 compressed^=0"
